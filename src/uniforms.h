...
glm::mat4 createShipModelMatrix(glm::vec3 translationVector, glm::vec3 scaleVector) {
    // ajustar la nave en z
    ...
    return translate * scale * rotation; // Ajustar en Y no es necesario.
}
